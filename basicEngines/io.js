...
class IOEngine{
	...
	constructor(){
		this.Draw=class DrawClass{
			...
			Text({c=[0,0],coords=c,x=coords[0],y=coords[1],text,font="sans-serif",size=10,color="white",align="center"}){
		...
		this.Time=class Time{
			...
			startLoop(){//called every game loop
		...
		this.Sound=(function() {
			...
			return { play, pause, rewind, start, stop};
		})();
	}
}
(new IOEngine()).start();
